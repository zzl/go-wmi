...
func NewSWbemQualifierSetFromVar(v ole.Variant, addRef bool, scoped bool) *SWbemQualifierSet {
	return NewSWbemQualifierSet(v.IDispatch(), addRef, scoped)
}
...
func NewSWbemQualifierSetInstance(scoped bool) (*SWbemQualifierSet, error) {
	...
	return NewSWbemQualifierSet(p, false, scoped), nil
}
